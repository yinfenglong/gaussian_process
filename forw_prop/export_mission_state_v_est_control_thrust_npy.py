...
usage
    ...
    python3 export_mission_state_v_est_control_thrust_npy.py q330/20210913_4_20_random
'''
...
class UAVSubNpy(object):
    def __init__(self):
        ...
        self.thrust_com_cmd_sub = rospy.Subscriber(
            '/itm_quadrotor_control/thrust_compensated', AccelStamped, self.com_thrust_callback)
        self.thrust = None
    ...
    def com_thrust_callback(self, msg):
        self.thrust = np.array([msg.accel.linear.z])
    ...
    while not rospy.is_shutdown():
        ...
        # elif sub_obj.command_id == 5: 
            data_list.append(np.append(np.append(sub_obj.uav_pose.flatten(),
                                    sub_obj.att_rate_cmd.flatten()), sub_obj.thrust.flatten()))
        rate.sleep()
