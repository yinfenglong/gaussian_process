...
LastEditors: Wei Luo
LastEditTime: 2021-11-15 22:09:58
Note: Note
'''
import casadi as ca
...
class QuadRotorModel(object):
    def __init__(self, ):
        ...
        controls = ca.vcat(
            [roll_rate_ref_, pitch_rate_ref_, yaw_rate_ref_, thrust_ref_])
        ...
        rhs = [
            vx_, vy_, vz_, 0.5 * (-roll_rate_ref_ * qx_ -
                                  pitch_rate_ref_ * qy_ - yaw_rate_ref_ * qz_),
            0.5 * (roll_rate_ref_ * qw_ + yaw_rate_ref_ * qy_ -
                   pitch_rate_ref_ * qz_),
            0.5 * (pitch_rate_ref_ * qw_ - yaw_rate_ref_ * qx_ +
                   roll_rate_ref_ * qz_),
            0.5 * (yaw_rate_ref_ * qw_ + pitch_rate_ref_ * qx_ -
                   roll_rate_ref_ * qy_),
