...
usage
    ...
    python3 gpr_GPyTorch_train.py q330/20210913_4_20_random vz y_vz
'''
...
torch.save(model.state_dict(), './' +  sys.argv[1] + '/train_pre_model/model_state_' + sys.argv[2] +'.pth')
likelihood_state_dict = likelihood.state_dict()
# torch.save(likelihood_state_dict, './likelihood_state.pth')
torch.save(likelihood_state_dict, './' + sys.argv[1] + '/train_pre_model/likelihood_state_' + sys.argv[2] +'.pth')
